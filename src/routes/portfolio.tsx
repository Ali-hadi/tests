...
const projects = [
  {
    ...
    d: "Real-time predictive modeling platform unifying 14 data sources across 60+ global warehouses.",
    stack: "Next.js · Python · PostgreSQL · OpenAI",
    result: "84% ops reduction",
  },
  {
    img: case2,
    ...
    tag: "Automation",
    t: "AutoFlow Engine",
    d: "End-to-end workflow automation serving 12k+ users with sub-second triggers.",
  ...
  },
  {
    ...
    t: "Pulse Health App",
    d: "AI wellness companion with on-device inference and HIPAA-grade security.",
    stack: "React Native · CoreML · Supabase",
    result: "4.8★ rating",
  },
];
      ...
      <section className="pb-32 space-y-24 lg:space-y-32">
        {projects.map((p, i) => (
          <Reveal key={i}>
            <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
              <div
                className={`grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center ${i % 2 ? "lg:flex-row-reverse" : ""}`}
              >
                ...
                <div className="lg:col-span-5">
                  ...
                  <span className="px-4 py-2 glass rounded-full text-[10px] font-mono uppercase tracking-widest text-orange">
                    {p.tag}
                  </span>
                </div>
              </div>
