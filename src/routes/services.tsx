...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI Agents, Automation, Custom SaaS, Web & Mobile Apps, CRM/ERP, Cloud & DevOps. Fixed-price or hourly. 24/7 global delivery." },
      { property: "og:title", content: "Services — AItouchSolutions" },
      { property: "og:description", content: "End-to-end AI and software services for global clients." },
    ],
  }),
...
const groups = [
  {
    ...
    items: [
      { t: "AI Agent Development", d: "Autonomous LLM agents that reason and execute multi-step workflows." },
      ...
      { t: "AI Chatbots", d: "Production-grade conversational AI with RAG over your knowledge base." },
    ...
    <>
      <section className="pt-40 lg:pt-52 pb-20 lg:pb-32">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <Reveal>
            <p className="font-mono text-[10px] uppercase tracking-[0.35em] text-teal mb-8">Services</p>
            ...
            <p className="mt-10 max-w-2xl text-lg text-muted-foreground leading-relaxed">
              A complete software studio across AI, product engineering, design, and cloud — engaged on fixed-price or hourly terms, 24/7 globally.
            </p>
          </Reveal>
        </div>
      </section>
            ...
            <Reveal key={g.label}>
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 border-t border-border pt-12">
                <div className="lg:col-span-4 lg:sticky lg:top-32 h-fit">
                  <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-teal mb-4">/ 0{gi + 1}</p>
                  <h2 className="font-display text-4xl lg:text-5xl font-bold tracking-tight">{g.label}</h2>
                </div>
                <div className="lg:col-span-8 grid sm:grid-cols-2 gap-px bg-border">
                  {g.items.map((it) => (
                    <div key={it.t} className="bg-background p-8 hover:bg-ink-2 transition-colors group">
                      <h3 className="font-display text-xl font-bold mb-3 group-hover:text-teal transition-colors">{it.t}</h3>
