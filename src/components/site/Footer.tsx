        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <h3 className="font-display text-3xl lg:text-5xl leading-[0.95] tracking-tight mb-8 max-w-md">
              Let's build the <span className="text-teal">intelligence layer</span> of your business.
            </h3>
            <Link
              to="/contact"
              className="inline-flex items-center gap-3 group"
            >
              <span className="font-display text-2xl group-hover:text-teal transition-colors">Start a project</span>
              <span className="w-12 h-12 rounded-full bg-teal text-ink grid place-items-center text-xl group-hover:bg-orange transition-colors">→</span>
            </Link>
          </div>
          <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8 lg:gap-12 text-sm">
            <div>
              <p className="text-[10px] font-mono uppercase tracking-[0.3em] text-muted-foreground mb-5">Platform</p>
              <ul className="space-y-3">
                <li><Link to="/services" className="hover:text-teal">Services</Link></li>
                <li><Link to="/ai-solutions" className="hover:text-teal">AI Solutions</Link></li>
                <li><Link to="/technologies" className="hover:text-teal">Technologies</Link></li>
                <li><Link to="/pricing" className="hover:text-teal">Pricing</Link></li>
              </ul>
            </div>
            <div>
              <p className="text-[10px] font-mono uppercase tracking-[0.3em] text-muted-foreground mb-5">Company</p>
              <ul className="space-y-3">
                <li><Link to="/about" className="hover:text-teal">About</Link></li>
                <li><Link to="/portfolio" className="hover:text-teal">Portfolio</Link></li>
                <li><Link to="/contact" className="hover:text-teal">Contact</Link></li>
              </ul>
            </div>
            <div>
              <p className="text-[10px] font-mono uppercase tracking-[0.3em] text-muted-foreground mb-5">Operations</p>
